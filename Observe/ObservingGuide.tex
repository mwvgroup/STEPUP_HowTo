...
Humidity: \\
Temperature: \\ \\
Target:\hspace{75pt}Mag: \\
RA:\hspace{90pt}Dec: \\ \\
(start time) pm - Began setup \\ \\
\textcolor{red}{In this space, record times at which you began: \\
-taking calibration images. \\
-focusing the telescope. \\ \\
Note: Record if you needed to refocus the telescope due to weather and the time of refocus.} \\ \\
MaxIM:\hspace{72pt}FWHM:\hspace{75pt}HFD: \\ \\
(guiding start time) pm - Began guiding \\ \\
Guide Star:\hspace{54pt}Mag: \\
RA:\hspace{90pt}Dec: \\ \\
(sequence start time) pm - Began sequencing \\ \\
Filter:\hspace{80pt}Exposure Time: \\ \\
\textcolor{red}{In this space, record image information every 30 min until the transit ends with the following format:} \\ \\ \\
(time image is checked)\hspace{5pt}(number of the image and filter) \\ \\
FWHM:\hspace{65pt}Bkgr(avg): \\
Star(max):\hspace{53pt}Star(min): \\ \\
(shut down time) am - Shut down
