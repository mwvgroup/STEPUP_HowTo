...
\linebreak {\bf \emph{Note:}} you may reuse new-image.fits file for the same target that are saved in {\bf /home/depot/ \linebreak STEPUP/analysis\_history}, but you should only do this if you are sure that the new-image.fits file and your images that you are processing are centered at the same position.
